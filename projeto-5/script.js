...
perguntas = [
    {
        ...
        respostas: [
            { opcao: "Monkey", correto: false },
            { opcao: "Pikachu", correto: true },
            { opcao: "Charmander", correto: false }
        ]
    },
    {
        pergunta: "Qual é o tipo do Pokémon Bulbasaur?",
        respostas: [
            { opcao: "Planta/Veneno", correto: true },
            { opcao: "Água", correto: false },
            { opcao: "Fogo", correto: false }
        ]
    },
    {
        pergunta: "Qual desses Pokémon é do tipo fogo?",
        respostas: [
    ...
    {
        pergunta: "Qual desses Pokémon é do tipo água?",
        respostas: [
